...
SCANREFER = json.load(open(os.path.join(CONF.PATH.SCANREFER, "ScanRefer_filtered.json")))
...
with open(os.path.join(CONF.PATH.SCANREFER, "ScanRefer_filtered_organized.json"), "w") as f:
